...
from .views import DietPlanListView, DietPlanDetailView, DailyDietPlanListView, DailyDietPlanDetailView, AddToDietPlanView, WeeklyLogView
...
urlpatterns = [
    ...
    path('weekly-log/', WeeklyLogView.as_view(), name='weekly_log'),  # New URL for handling the weekly log entry
]
